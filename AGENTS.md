...
Never remove Daytona's copyright or `SPDX-License-Identifier` lines from files with upstream code. Keep `LICENSE`, `package.json`, and README "Credits & License" consistent. Package name is `opencode-remote-plugin` — no Daytona branding.
